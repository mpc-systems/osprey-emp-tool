...
int hash_in_circuit() {
	...
	aes_128_ctr_calculator.aes_128_ctr(&(key_integer[0].bit), &(iv_integer[0].bit), &(input_integer[0].bit),
	...
	aes_128_ctr_calculator.aes_128_ctr(&(key_integer[0].bit), iv, &(input_integer[0].bit), &(output_integer[0].bit),
									   2000 * 8, emp::PUBLIC, 77777);
	...
	aes_128_ctr_calculator.aes_128_ctr(key, iv, &(input_integer[0].bit), &(output_integer[0].bit), 2000 * 8,
									   emp::PUBLIC, 77777);
